...
/**
 * A single CLIP layer stepper field with constraints dynamically loaded
 ...
 * @param value Current CLIP layer value
...
fun ClipLayerField(
    ...
    val constraints = WorkflowConstraintsProvider.rememberConstraints("stop_at_clip_layer", workflowName)
    ...
    NumericStepperField(
        ...
        label = stringResource(R.string.label_stop_at_clip_layer),
        min = constraints.min,
        max = constraints.max,
